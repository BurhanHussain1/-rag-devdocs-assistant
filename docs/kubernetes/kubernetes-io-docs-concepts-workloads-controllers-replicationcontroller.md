...
[`controllers/replication.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/controllers/replication.yaml)![](/images/copycode.svg "Copy controllers/replication.yaml to clipboard")
...
[ReplicationController API object](/docs/reference/generated/kubernetes-api/v1.36/#replicationcontroller-v1-core).
...
* `ReplicationController` is part of the Kubernetes REST API.
  Read the
  [ReplicationController](/docs/reference/kubernetes-api/core/replication-controller-v1/)
