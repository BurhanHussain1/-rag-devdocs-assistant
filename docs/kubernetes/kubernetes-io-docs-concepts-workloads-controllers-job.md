...
[`controllers/job.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/controllers/job.yaml)![](/images/copycode.svg "Copy controllers/job.yaml to clipboard")
...
2. Creates a [PodGroup](/docs/reference/kubernetes-api/workload-resources/workload-v1alpha1/)
...
[`/controllers/job-backoff-limit-per-index-example.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples//controllers/job-backoff-limit-per-index-example.yaml)![](/images/copycode.svg "Copy /controllers/job-backoff-limit-per-index-example.yaml to clipboard")
...
[`/controllers/job-pod-failure-policy-example.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples//controllers/job-pod-failure-policy-example.yaml)![](/images/copycode.svg "Copy /controllers/job-pod-failure-policy-example.yaml to clipboard")
...
[`/controllers/job-success-policy.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples//controllers/job-success-policy.yaml)![](/images/copycode.svg "Copy /controllers/job-success-policy.yaml to clipboard")
...
* `Job` is part of the Kubernetes REST API.
  Read the
  [Job](/docs/reference/kubernetes-api/batch/job-v1/)
