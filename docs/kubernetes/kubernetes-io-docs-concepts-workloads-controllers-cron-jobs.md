...
[`application/job/cronjob.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/application/job/cronjob.yaml)![](/images/copycode.svg "Copy application/job/cronjob.yaml to clipboard")
...
* `CronJob` is part of the Kubernetes REST API.
  Read the
  [CronJob](/docs/reference/kubernetes-api/batch/cron-job-v1/)
