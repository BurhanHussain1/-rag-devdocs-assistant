...
[`application/deployment-sidecar.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/application/deployment-sidecar.yaml)![](/images/copycode.svg "Copy application/deployment-sidecar.yaml to clipboard")
...
[`application/job/job-sidecar.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/application/job/job-sidecar.yaml)![](/images/copycode.svg "Copy application/job/job-sidecar.yaml to clipboard")
