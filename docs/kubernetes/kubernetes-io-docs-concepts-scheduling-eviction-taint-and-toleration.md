...
[`pods/pod-with-toleration.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/pods/pod-with-toleration.yaml)![](/images/copycode.svg "Copy pods/pod-with-toleration.yaml to clipboard")
...
[`pods/pod-with-numeric-toleration.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/pods/pod-with-numeric-toleration.yaml)![](/images/copycode.svg "Copy pods/pod-with-numeric-toleration.yaml to clipboard")
