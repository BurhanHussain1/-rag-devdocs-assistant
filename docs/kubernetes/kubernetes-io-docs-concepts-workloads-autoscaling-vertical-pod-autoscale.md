...
![Vertical Pod Autoscaling architecture](/images/docs/concepts/vpa-architecture.svg)
...
You can also read more about [*horizontal* Pod autoscaling](/docs/concepts/workloads/autoscaling/horizontal-pod-autoscale/).
...
Last modified May 31, 2026 at 9:35 AM PST: [docs: add InPlace VPA update mode documentation (645f2395fd)](https://github.com/kubernetes/website/commit/645f2395fda6a99218619b38fc65c56b1373e0e5)