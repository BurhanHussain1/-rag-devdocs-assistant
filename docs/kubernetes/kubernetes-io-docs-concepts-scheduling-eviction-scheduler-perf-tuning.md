...
2. Set `IgnorePreferredTermsOfExistingPods` of [InterPodAffinityArgs](/docs/reference/config-api/kube-scheduler-config.v1/#kubescheduler-config-k8s-io-v1-InterPodAffinityArgs)
...
Last modified February 26, 2026 at 9:59 PM PST: [Opportunistic Batching feature docs update for 1.36 (2cfd095d5d)](https://github.com/kubernetes/website/commit/2cfd095d5df80d838a5e9dc7bcfc3078b9cdd7c7)