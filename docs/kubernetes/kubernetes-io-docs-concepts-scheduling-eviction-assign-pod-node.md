...
[`pods/pod-with-node-affinity.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/pods/pod-with-node-affinity.yaml)![](/images/copycode.svg "Copy pods/pod-with-node-affinity.yaml to clipboard")
...
[`pods/pod-with-affinity-preferred-weight.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/pods/pod-with-affinity-preferred-weight.yaml)![](/images/copycode.svg "Copy pods/pod-with-affinity-preferred-weight.yaml to clipboard")
...
[`pods/pod-with-pod-affinity.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/pods/pod-with-pod-affinity.yaml)![](/images/copycode.svg "Copy pods/pod-with-pod-affinity.yaml to clipboard")
