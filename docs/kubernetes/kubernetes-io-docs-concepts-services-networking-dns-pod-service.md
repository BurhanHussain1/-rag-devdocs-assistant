...
[`service/networking/custom-dns.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/service/networking/custom-dns.yaml)![](/images/copycode.svg "Copy service/networking/custom-dns.yaml to clipboard")
