...
[`debug/counter-pod.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/debug/counter-pod.yaml)![](/images/copycode.svg "Copy debug/counter-pod.yaml to clipboard")
...
[`debug/counter-pod-err.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/debug/counter-pod-err.yaml)![](/images/copycode.svg "Copy debug/counter-pod-err.yaml to clipboard")
...
[`admin/logging/two-files-counter-pod.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/admin/logging/two-files-counter-pod.yaml)![](/images/copycode.svg "Copy admin/logging/two-files-counter-pod.yaml to clipboard")
...
[`admin/logging/two-files-counter-pod-streaming-sidecar.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/admin/logging/two-files-counter-pod-streaming-sidecar.yaml)![](/images/copycode.svg "Copy admin/logging/two-files-counter-pod-streaming-sidecar.yaml to clipboard")
...
[`admin/logging/fluentd-sidecar-config.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/admin/logging/fluentd-sidecar-config.yaml)![](/images/copycode.svg "Copy admin/logging/fluentd-sidecar-config.yaml to clipboard")
...
[`admin/logging/two-files-counter-pod-agent-sidecar.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/admin/logging/two-files-counter-pod-agent-sidecar.yaml)![](/images/copycode.svg "Copy admin/logging/two-files-counter-pod-agent-sidecar.yaml to clipboard")
