...
[`pods/topology-spread-constraints/one-constraint.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/pods/topology-spread-constraints/one-constraint.yaml)![](/images/copycode.svg "Copy pods/topology-spread-constraints/one-constraint.yaml to clipboard")
...
[`pods/topology-spread-constraints/two-constraints.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/pods/topology-spread-constraints/two-constraints.yaml)![](/images/copycode.svg "Copy pods/topology-spread-constraints/two-constraints.yaml to clipboard")
