...
[`pods/pod-with-scheduling-gates.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/pods/pod-with-scheduling-gates.yaml)![](/images/copycode.svg "Copy pods/pod-with-scheduling-gates.yaml to clipboard")
...
[`pods/pod-without-scheduling-gates.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/pods/pod-without-scheduling-gates.yaml)![](/images/copycode.svg "Copy pods/pod-without-scheduling-gates.yaml to clipboard")
