...
[`pods/resource/pod-level-resources.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/pods/resource/pod-level-resources.yaml)![](/images/copycode.svg "Copy pods/resource/pod-level-resources.yaml to clipboard")
