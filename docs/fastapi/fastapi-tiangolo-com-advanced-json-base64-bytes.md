...
Consider first if you can use [Request Files](../../tutorial/request-files/) for uploading binary data and [Custom Response - FileResponse](.././custom-response/#fileresponse) for sending binary data, instead of encoding it in JSON.
...
![](/img/tutorial/json-base64-bytes/image01.png)
