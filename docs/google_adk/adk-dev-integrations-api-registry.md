---
url: https://adk.dev/integrations/api-registry/
title: Google Cloud API Registry tool for ADK
...
[api\_registry\_agent](https://github.com/google/adk-python/tree/main/contributing/samples/integrations/api_registry_agent/)
