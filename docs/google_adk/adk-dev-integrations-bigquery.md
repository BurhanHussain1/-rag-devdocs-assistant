---
url: https://adk.dev/integrations/bigquery/
title: BigQuery tool for ADK
...
* **`detect_anomalies`**: Trains an ARIMA\_PLUS model and detects anomalies in time series data.
