---
url: https://adk.dev/agents/custom-agents/
title: Custom agent template workflows
...
Allows an [`LlmAgent`](../llm-agents/) to treat another `BaseAgent` instance as a callable function or
[Tool](/tools-custom/).
