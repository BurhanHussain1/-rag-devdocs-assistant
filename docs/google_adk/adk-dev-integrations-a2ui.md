...
title: A2UI — Agent-to-UI for ADK
...
| Sample | Description |
| --- | --- |
| [restaurant\_finder](https://github.com/a2ui-project/a2ui/tree/main/samples/agent/adk/restaurant_finder) | Static schema agent for searching and displaying restaurant information |
