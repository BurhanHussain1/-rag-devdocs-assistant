---
url: https://adk.dev/integrations/cisco-ai-defense/
title: Cisco AI Defense plugin for ADK
...
* **Auditable decision trace and alerts**: Capture decision context (action,
  severity, classifications, request\_id/event\_id) and optionally trigger an
