...
`RoutedAgent` is different from [workflow agents](../workflow-agents/) like
...
model-level routing, see [Model routing](../models/routing/).

## How routing works

Both `RoutedAgent` and [`RoutedLlm`](../models/routing/) are powered by a shared
