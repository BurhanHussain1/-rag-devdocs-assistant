---
url: https://adk.dev/deploy/gke/
title: Deploy to Google Kubernetes Engine (GKE)
...
[Setup and Installation](../../get-started/installation/) guide. You will also
...
| --service\_type | The type of Kubernetes service to create. Accepts `ClusterIP` (default) or `LoadBalancer`. | No |
