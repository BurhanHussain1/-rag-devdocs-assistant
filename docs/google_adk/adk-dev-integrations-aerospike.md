---
url: https://adk.dev/integrations/aerospike/
title: Aerospike integration for ADK
...
Session + RunnerSession APIMemory serviceArtifact serviceAll three services`adk web` and `adk run`
