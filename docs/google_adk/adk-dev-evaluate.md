...
* **multi\_turn\_task\_success\_v1**: Evaluates if agent achieves goal(s) of
  conversation.
* **multi\_turn\_trajectory\_quality\_v1**: Evaluates the overall trajectory of
  the conversation.
* **multi\_turn\_tool\_use\_quality\_v1**: Evaluates function calls made during a
  conversation.
