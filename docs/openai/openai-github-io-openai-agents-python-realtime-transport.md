---
url: https://openai.github.io/openai-agents-python/realtime/transport/
...
| Goal | Start with | Why |
| --- | --- | --- |
| Build a server-managed realtime app | [Quickstart](../quickstart/) | The default Python path is a server-side WebSocket session managed by `RealtimeRunner`. |
...
| Attach agents to phone or SIP calls | [Realtime guide](../guide/) and [`examples/realtime/twilio_sip`](https://github.com/openai/openai-agents-python/tree/main/examples/realtime/twilio_sip) | The repo ships a SIP attach flow driven by `call_id`. |
...
The transport configuration surface in [`RealtimeModelConfig`](../../ref/realtime/config/#agents.realtime.model.RealtimeModelConfig) lets you adapt the default paths:
...
See the [Realtime agents guide](../guide/) for the detailed lifecycle and capability surface once you've chosen a topology.