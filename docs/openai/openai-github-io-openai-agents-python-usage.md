---
url: https://openai.github.io/openai-agents-python/usage/
title: Usage
framework: openai
---
...
* **request\_usage\_entries**: list of per-request usage breakdowns
* **details**:
...
Review the adapter-specific notes in the [Third-party adapters](../models/#third-party-adapters) section of the Models guide and validate the exact provider backend you plan to deploy.
...
* [`Usage`](../ref/usage/#agents.usage.Usage "Usage") - Usage tracking data structure
* [`RequestUsage`](../ref/usage/#agents.usage.RequestUsage "RequestUsage") - Per-request usage details
* [`RunContextWrapper`](../ref/run_context/#agents.run_context.RunContextWrapper "RunContextWrapper

    
        dataclass
    ") - Access usage from run context
* [`RunHooks`](../ref/lifecycle/#agents.lifecycle.RunHooks "RunHooks

    
        module-attribute
    ") - Hook into usage tracking lifecycle