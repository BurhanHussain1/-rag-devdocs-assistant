...
* The [`CodeInterpreterTool`](../ref/tool/#agents.tool.CodeInterpreterTool "CodeInterpreterTool

    
        dataclass
    ") lets the LLM execute code in a sandboxed environment.
* The [`HostedMCPTool`](../ref/tool/#agents.tool.HostedMCPTool "HostedMCPTool

    
        dataclass
    ") exposes a remote MCP server's tools to the model.
* The [`ImageGenerationTool`](../ref/tool/#agents.tool.ImageGenerationTool "ImageGenerationTool

    
        dataclass
    ") generates images from a prompt.
* The [`ToolSearchTool`](../ref/tool/#agents.tool.ToolSearchTool "ToolSearchTool
...
* Tool search activity appears in [`RunResult.new_items`](../results/#new-items) and in [`RunItemStreamEvent`](../streaming/#run-item-event-names) with dedicated item and event types.
...
* [`ComputerTool`](../ref/tool/#agents.tool.ComputerTool "ComputerTool
        ...
        dataclass
    "): implement the [`Computer`](../ref/computer/#agents.computer.Computer "Computer") or [`AsyncComputer`](../ref/computer/#agents.computer.AsyncComputer "AsyncComputer") interface to enable GUI/browser automation.
* [`ShellTool`](../ref/tool/#agents.tool.ShellTool "ShellTool

    
        dataclass
    "): the latest shell tool for both local execution and hosted container execution.
* [`LocalShellTool`](../ref/tool/#agents.tool.LocalShellTool "LocalShellTool

    
        dataclass
    "): legacy local-shell integration.
* [`ApplyPatchTool`](../ref/tool/#agents.tool.ApplyPatchTool "ApplyPatchTool

    
        dataclass
    "): implement [`ApplyPatchEditor`](../ref/editor/#agents.editor.ApplyPatchEditor "ApplyPatchEditor") to apply diffs locally.
...
`ComputerTool` is still a local harness: you provide a [`Computer`](../ref/computer/#agents.computer.Computer "Computer") or [`AsyncComputer`](../ref/computer/#agents.computer.AsyncComputer "AsyncComputer") implementation, and the SDK maps that harness onto the OpenAI Responses API computer surface.
...
When a [`ComputerTool`](../ref/tool/#agents.tool.ComputerTool "ComputerTool
...
This distinction matters when `ComputerTool` is backed by a [`ComputerProvider`](../ref/tool/#agents.tool.ComputerProvider "ComputerProvider
...
When you are using OpenAI Responses models, `@function_tool(defer_loading=True)` hides a function tool until `ToolSearchTool()` loads it. You can also group related function tools with [`tool_namespace()`](../ref/tool/#agents.tool.tool_namespace "tool_namespace"). See [Hosted tool search](#hosted-tool-search) for the full setup and constraints.
...
* Images: [`ToolOutputImage`](../ref/tool/#agents.tool.ToolOutputImage "ToolOutputImage") (or the TypedDict version, [`ToolOutputImageDict`](../ref/tool/#agents.tool.ToolOutputImageDict "ToolOutputImageDict"))
* Files: [`ToolOutputFileContent`](../ref/tool/#agents.tool.ToolOutputFileContent "ToolOutputFileContent") (or the TypedDict version, [`ToolOutputFileContentDict`](../ref/tool/#agents.tool.ToolOutputFileContentDict "ToolOutputFileContentDict"))
* Text: either a string or stringable objects, or [`ToolOutputText`](../ref/tool/#agents.tool.ToolOutputText "ToolOutputText") (or the TypedDict version, [`ToolOutputTextDict`](../ref/tool/#agents.tool.ToolOutputTextDict "ToolOutputTextDict"))
...
* `timeout_behavior="raise_exception"`: raise [`ToolTimeoutError`](../ref/exceptions/#agents.exceptions.ToolTimeoutError "ToolTimeoutError") and fail the run.
...
Inside a custom extractor, the nested [`RunResult`](../ref/result/#agents.result.RunResult "RunResult

  
      dataclass
  ") also exposes [`agent_tool_invocation`](../ref/result/#agents.result.RunResultBase.agent_tool_invocation "agent_tool_invocation

  
      property
  "), which is useful when you need the outer tool name, call ID, or raw arguments while post-processing the nested result. See the [Results guide](../results/#agent-as-tool-metadata).
...
* [Codex tool API reference](../ref/extensions/experimental/codex/codex_tool/)
* [ThreadOptions reference](../ref/extensions/experimental/codex/thread_options/)
* [TurnOptions reference](../ref/extensions/experimental/codex/turn_options/)
